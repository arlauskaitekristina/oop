...
public class Human {
    ...
    public void addCommunication(Human human, TypeCommunication typeCommunication) {
        ...
        if (typeCommunication == TypeCommunication.Daughter && this.getGender() == TypeGender.Female
                || typeCommunication == TypeCommunication.Son && this.getGender() == TypeGender.Female) {
            human.addCommunication(new FamilyCommunication(this, TypeCommunication.Mother));
        }
        if (typeCommunication == TypeCommunication.Daughter && this.getGender() == TypeGender.Male
                || typeCommunication == TypeCommunication.Son && this.getGender() == TypeGender.Male) {
